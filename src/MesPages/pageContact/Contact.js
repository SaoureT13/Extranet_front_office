      ...
      <div className="page-content contact-us">
        <div className="container">
          <section className="content-title-section mb-10">
            ...
            <p className="text-center w-50 d-block mx-auto mt-5"> À SN PROVECI, vous trouverez toujours une oreille attentive à vos préoccupations et recevrez des conseils pertinents. Pour prendre un Rendez-vous, se faire livrer ou pour obtenir des informations complémentaires.</p>
          </section>
            ...
            <div className="swiper-container swiper-theme" >
              ...
              <div className="swiper-slide icon-box text-center icon-box-primary col-lg-3">
                  ...
                  <div className="icon-box-content">
                    <h4 className="icon-box-title">Nous contacter</h4>
                    <p>(+225) 27 21 35 30 27  / (+225) 01 02 48 70 53</p>
                ...
                <div className="swiper-slide icon-box text-center icon-box-primary col-lg-3">
                  ...
                  <div className="icon-box-content">
                    <h4 className="icon-box-title">Par E-mail</h4>
                ...
                <div className="swiper-slide icon-box text-center icon-box-primary col-lg-3">
                  ...
                  <div className="icon-box-content">
                    <h4 className="icon-box-title">Nous rencontrer</h4>
                    <p>Marcory Zone 4 rue G64 du canal boulevard <br/>À côté du Golden Hôtel 18 BP 2863 Abidjan 18</p>
                  </div>
                </div>
                <div className="swiper-slide icon-box text-center icon-box-primary col-lg-3">
          ...
          <section className="contact-section">
            <div className="row gutter-lg pb-3">
              <div className="col-lg-6 mb-8">
                <h4 className="title mb-3">Horaire d'ouverture</h4>
                  ...
                  <div className="card">
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-7 col-sm-6">
                            ...
                            <ul className="widget-body">
                                <li>
                                <a href="#">Lundi   8h à 12h – 13h à 16h40s</a>
                                </li>
                                <li>
                                <a href="#">Mardi    8h à 12h – 13h à 16h40!</a>
                                </li>
                                <li>
                                <a href="#">Mercredi    8h à 12h – 13h à 16h40</a>
                                </li>
                                <li>
                                <a href="#">Jeudi    8h à 12h – 13h à 16h40</a>
                                </li>
                                <li>
                                <a href="#">Vendredi    8h à 12h – 13h à 16h40</a>
                                </li>
                                <li>
                                <a href="#">Samedi    9h à 12h</a>
                                <a href="#">Dimanche et jours fériés <span className='badge badge-danger'>Fermé</span> </a>
                                </li>
                            </ul>
                            </div>
                        </div>
              ...
              <div className="col-lg-6 mb-8">
                <h4 className="title mb-3">Nous écrire message</h4>
                <form className="form contact-us-form" action="#" method="post">
                  ...
                  <div className="form-group">
                    ...
                    <textarea id="message" name="message" cols={30} rows={5} className="form-control"></textarea>
                  </div>
